...
function App() {
  ...
  return (
    <ToastProvider>
      <AppContent />
      {modelError && (
        <div className="fixed bottom-4 right-4 bg-red-500/90 text-white p-4 rounded-lg max-w-md">
          <p className="font-semibold">Model Initialization Failed</p>
          <p className="text-sm">{modelError}</p>
          <p className="text-xs mt-2">Background removal will not work.</p>
        </div>
      )}
    </ToastProvider>
  );
